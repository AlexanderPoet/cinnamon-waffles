...
var App = function (_Component) {
  ...
  function App(x) {
    ...
    var _this = _possibleConstructorReturn(this, (App.__proto__ || Object.getPrototypeOf(App)).call(this, x));

    _this.choosing = false;
    _this.state = {
      user: new _utils.User('Po'),
      wo: []
    };
    return _this;
  }
  ...
  _createClass(App, [{
    ...
    key: 'init',
    value: function init() {
      var wo = this.state.wo;

      var hold = this.state.user.requestWorkout();
      hold.confirm();
      console.log(hold);
...
exports.default = function () {
  var workouts = ['Back', 'Chest', 'Arms', 'Legs', 'Abs', 'Shoulders']; // examples
  var createUser = function createUser() {}; //async create a user return dope object of staties;
  return function () {
    function _class(x) {
    ...
    _createClass(_class, [{
      key: 'addWorkout',
      value: function addWorkout(x) {}
    }, {
      key: 'requestWorkout',
      value: function requestWorkout() {
        return {};
      }
    }]);
